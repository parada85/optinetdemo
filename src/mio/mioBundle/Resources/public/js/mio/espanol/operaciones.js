$(document).ready(function () {
	var redondeo=0;
				...
				for ( var i=0 ; i<parseInt(tdtabla4.length); i=i+6 ){	
						if ($(tdtabla4[i]).text() == id){
						   chivato=1;
							...
							tabla4.fnUpdate( cantidad1+cantidad + " unidad/es", i/6, 2 );
            ...
            if (chivato==0){
				...
				tabla4.fnAddData( [id,descripcion,cantidad + " unidad/es",precio + " €",redondeo + " €",'<div class="sumar1">Sumar</div><div class="restar1">Restar</div><div class="eliminar1">Eliminar</div>']);
				...
				for ( var i=0 ; i<parseInt(tdtabla4.length); i=i+7 ){	
						if ($(tdtabla4[i]).text() == id){
						   chivato=1;
							...
							tabla4.fnUpdate( cantidad1+cantidad + " unidad/es", i/7, 2 );
							tabla4.fnUpdate( redondeo + " €", i/7, 4 );
							tabla3.fnUpdate( cantidad1 + cantidad + " unidad/es", aPos, 4 );
							antes = parseFloat($('#totalventa').html());
							redondeo = antes + (cantidad)*precio;
							redondeo = Math.round(redondeo*100)/100;	
							$("#totalventa").html(redondeo);
            ...
            if (chivato==0){
            tabla3.fnUpdate( stockreservado + cantidad + " unidad/es", aPos, 4 );
            	redondeo = cantidad*precio;
				redondeo =Math.round(redondeo*100)/100 ;			
				tabla4.fnAddData( [id,descripcion,cantidad + " unidad/es",precio + " €",redondeo + " €",'<div class="sumarreserva">Sumar</div><div class="restarreserva">Restar</div><div class="eliminarreserva">Eliminar</div>']);
				...
				for ( var i=0 ; i<parseInt(tdtabla2.length); i=i+6 ){	
						if ($(tdtabla2[i]).text() == id){
						   chivato=1;
							...
							tabla2.fnUpdate( cantidad1+cantidad + " unidad/es", i/11, 2 );
							redondeo = (cantidad1+cantidad)*precio;
							redondeo = Math.round(redondeo*100)/100;	
							tabla2.fnUpdate( redondeo +" €", i/11, 4 );
							tabla1.fnUpdate( stock-cantidad + " unidad/es", aPos, 2 );
							antes = parseFloat($('#totalventa').html());
							redondeo = antes + (cantidad)*precio;
							redondeo = Math.round(redondeo*100)/100;	
							$("#totalventa").html(redondeo);
            ...
            tabla1.fnUpdate( stock-cantidad + " unidad/es", aPos, 2 );
            	redondeo = cantidad*precio;
				redondeo =Math.round(redondeo*100)/100 ;			
				tabla2.fnAddData( [id,descripcion,cantidad + " unidad/es",precio + " €",redondeo + " €",'<div class="sumar">Sumar</div><div class="restar">Restar</div><div class="eliminar">Eliminar</div>']);
				var antes=$('#totalventa').text();
				redondeo = Math.round((parseFloat(antes) + redondeo)*100)/100;
				$("#totalventa").html(redondeo);
				...
				for ( var i=0 ; i<parseInt(tdtabla1.length); i=i+8 ){
						if ($(tdtabla1[i]).text() == id){
							...
							tabla1.fnUpdate( stock+cantidad2 + " unidad/es", i/8, 2 );
							var antes=$('#totalventa').text();
				...
				tabla2.fnUpdate( parseInt($(tdtabla2[2]).text())-1 + " unidad/es", aPos, 2 );
				...
				for ( var i=0 ; i<parseInt(tdtabla1.length); i=i+8 ){	
						if ($(tdtabla1[i]).text() == id){
							stock =  parseInt($(tdtabla1[i+2]).text());
							tabla1.fnUpdate( stock+1 + " unidad/es", i/8, 2 );
				...
				for ( var i=0 ; i < parseInt(tdtabla3.length); i=i+8 ){
						if ($(tdtabla3[i]).text() == id){
							...
							tabla3.fnUpdate( stockreservado - cantidad2 + " unidad/es", i/8, 4 );
							var antes = $('#totalventa').text();
							redondeo =Math.round((parseFloat(antes)-cantidad2*precio)*100)/100;
							$("#totalventa").html(redondeo);
					}
				...
				tabla4.fnUpdate( parseInt($(tdtabla4[2]).text())-1 + " unidad/es", aPos, 2 );
				var id = parseInt($(tdtabla4[0]).text());
				var tdtabla3 = $('td',tabla3.fnGetNodes());
				...
				for ( var i=0 ; i<parseInt(tdtabla3.length); i=i+8 ){
						if ($(tdtabla3[i]).text() == id){
							...
							tabla3.fnUpdate( stockreservado -1 + " unidad/es", i/8, 4 );

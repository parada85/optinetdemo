...
$('#calendarioarqueo').fullCalendar(
        ...
        ,eventRender: function(event, element) {
                element.qtip({
                  content: 'Hora: '+ event.hora + '<br/>' + 'Realizado por: ' + event.empleado,
                  show: {
          ...
          if(event.efectivocontado!=null){
                ...
                element.find('.fc-event-title').append("<br/> Boletas: " + event.boletas + " Contadas: " + event.boletascontado + " Dif :"+ difboleta);
                element.find('.fc-event-title').append("<br/> Efectivo: " + event.efectivo + " Contado: " + event.efectivocontado + " Dif :"+ difefectivo);
              }
              } 
  });
 ...
 $('#calendar').fullCalendar(//calendario citas
        ...
        $('#calendar').fullCalendar( 'refetchEvents' );
            ...
            success: function(data) {
              ...
              if (event.empleado !=null){// es una cita y no un festivo
                ...
                element.qtip({
                  content: event.fecha + '<br/>' + 'Realizada por: ' + event.empleado,
                  show: {
                  effect: function(offset) {
                    $(this).slideDown(400); // "this" refers to the tooltip
                  }
      ...
      var dia = new Date();
       if (date < dia)
        ...
        var fecha = y + '-' + m + '-' + d + ' ' + t;
          ...
          $('#fechadialogo').html('Fecha: '+ d + '/' + m + '/' + y + ' ' + t);
    ...
    eventClick: function(calEvent, jsEvent, view) {
        if (calEvent.title!="Festivo" && calEvent.color!='black'){
